...
// FRF_GUI_OUTPUT_PREFS_1.0.31: startup presentation saved in Frodo Prefs
// Values deliberately match the v1.0.30 command-line output selector order.
enum {
        FRF_STARTUP_DISPLAY_WINDOWED = 0,
        FRF_STARTUP_DISPLAY_RTG = 1,
        FRF_STARTUP_DISPLAY_RGB = 2,
        FRF_STARTUP_DISPLAY_ASK = 3
};
...
public:
	...
	int StartupDisplay;		// Amiga startup output: window/RTG/RGB/requester
