...
#define GD_StartupDisplay                           31  /* FRF_GUI_OUTPUT_PREFS_1.0.31 */
...
extern struct Gadget        *PrefsGadgets[32];
...
extern UBYTE                *StartupDisplay0Labels[];
...
extern int StartupDisplayClicked( void );
